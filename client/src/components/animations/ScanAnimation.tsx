      ...
      <svg viewBox="0 0 200 200" overflow="visible" role="img">
        <defs>
          <radialGradient id="radar-grad" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="rgba(111,217,210,0.05)" />
            <stop offset="100%" stopColor="rgba(111,217,210,0.18)" />
          </radialGradient>
          <linearGradient id="sweep-grad" x1="100" y1="100" x2="100" y2="22" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="rgba(111,217,210,0)" />
            <stop offset="40%" stopColor="rgba(111,217,210,0.05)" />
            <stop offset="100%" stopColor="rgba(111,217,210,0.55)" />
          </linearGradient>
        ...
        <g className="radar-sweep" clipPath="url(#radar-clip)">
          ...
          <line x1="100" y1="100" x2="178" y2="100" stroke="var(--cyan)" strokeWidth="1.5" strokeLinecap="round" />
        </g>

        <circle className="radar-center" cx="100" cy="100" r="3" />
        <circle cx="100" cy="100" r="6" fill="none" stroke="var(--cyan)" strokeWidth="1" opacity=".5" />
      </svg>
    </div>
  );
}
